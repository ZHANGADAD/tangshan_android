...
public class CirclePageIndicator extends View implements PageIndicator {
	...
	public void onPageScrolled(int position, float positionOffset,
		...
		if (isInLoop()) {
			...
			if (countChild > 0) {
				position = position % countChild;
				positionOffset = positionOffset % countChild;
			}
			mCurrentPage = position;
	...
	public void setInLoop(boolean isCircleLoope) {
		this.isCircleLoope = isCircleLoope;
	}

	public boolean isInLoop() {
		return isCircleLoope;
	}
}
